...
| :--- | :--- | :--- | :--- | :--- |
| Windows | Windows 10 pro及以上 \(64位\) | [Docker](https://docs.docker.com/docker-for-windows/install/) | [bioinfo\_tsinghua.docker.tar.gz](https://cloud.tsinghua.edu.cn/f/9296a08800c944499e7d/) | 安装Docker程序并下载image文件到桌面（`~/Desktop`） |
...
| Mac | 2010 or newer model | [Docker](https://docs.docker.com/docker-for-mac/install/) | [bioinfo\_tsinghua.docker.tar.gz](https://cloud.tsinghua.edu.cn/f/9296a08800c944499e7d/) | 安装Docker程序并下载image文件到桌面（`~/Desktop`） |
| Linux | kernel 3.10 or higher. | [Docker](https://docs.docker.com/v17.12/install/#server) | [bioinfo\_tsinghua.docker.tar.gz](https://cloud.tsinghua.edu.cn/f/9296a08800c944499e7d/) | 安装Docker程序并下载image文件到桌面（`~/Desktop`） |
