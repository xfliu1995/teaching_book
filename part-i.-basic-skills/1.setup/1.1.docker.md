...
| :--- | :--- | :--- | :--- | :--- |
| Windows | Windows 10 pro及以上 \(64位\) | [Docker](https://docs.docker.com/docker-for-windows/install/) | [bioinfo_PartI-PartII-PartIII1-3.tar.gz](https://cloud.tsinghua.edu.cn/f/a74250736c6748a0867b/) | 安装Docker程序并下载image文件到桌面（`~/Desktop`） |
...
| Mac | 2010 or newer model | [Docker](https://docs.docker.com/docker-for-mac/install/) | [bioinfo_PartI-PartII-PartIII1-3.tar.gz](https://cloud.tsinghua.edu.cn/f/a74250736c6748a0867b/) | 安装Docker程序并下载image文件到桌面（`~/Desktop`） |
| Linux | kernel 3.10 or higher. | [Docker](https://docs.docker.com/v17.12/install/#server) | [bioinfo_PartI-PartII-PartIII1-3.tar.gz](https://cloud.tsinghua.edu.cn/f/a74250736c6748a0867b/) | 安装Docker程序并下载image文件到桌面（`~/Desktop`） |
...
将 Docker image: [bioinfo_PartI-PartII-PartIII1-3.tar.gz](https://cloud.tsinghua.edu.cn/f/a74250736c6748a0867b/)下载到桌面，并且通过在 Power shell 中输入以下命令导入将镜像导入到 Docker 中。
