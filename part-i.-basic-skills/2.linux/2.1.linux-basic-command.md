...
> **注：**
>
> 我们准备了一个文件"test.gtf"用于下面的练习，把下文中的file\_name替换为test.gtf即可。
>
...
> **Tips:** 如果你是第一次使用 Vim，发现熟悉的 Terminal 不见了不要慌，按 `:q` 退回即可。 具体操作请参见 [这里](https://www.ctolib.com/docs/sfile/vbird-linux-basic-4e/80.html#922-按键说明)

## 11\) 视频教程

* Linux教学视频 [@Youtube](https://youtu.be/cOmJvMjn5CU) [@Bilibili](https://player.bilibili.com/player.html?aid=30590225&cid=53392482&page=1)  \([视频配套文档](https://lulab1.gitbook.io/training/part-i.-programming-skills/2.linux)\)
