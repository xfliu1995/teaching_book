...
3. 下载并解压 [`lulab-plot-master.zip`](https://cloud.tsinghua.edu.cn/f/aaad8a507dc645249eca/?dl=1), 双击其中的 `lulab-plot.Rproj`。
4. 安装需要的package:
...
1. Add summary statistics on a violin plot
...
1. Change violin plot fill colors
...
1. Add mean line on a histogram plot
...
1. Change histogram plot fill colors
...
1. Add mean line on a density plot
...
1. Change density plot fill colors
...
1. Add mean and standard deviation
...
1. Change dot colors, shapes and align types
...
1. Add regression lines and change the point colors, shapes and sizes
...
1. Draw the heatmap with the pheatmap package, pheatmap function
...
1. Draw the heatmap with the ggplot2 package
