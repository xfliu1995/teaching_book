...
下载 [GO\_gene.txt](https://github.com/lulab/teaching_book/tree/a477eeb385bf47dcc662cd104dca1bdb0a84b68c/files/go_kegg/GO.txt), 其内容如下所示：
...
1. 请选取上面30个基因，并重新进行GO注释，得出结果后，请举一个 GO term 例子，列出公式如何得出相对应的 expected, Fold Enrichment, raw P value。
2. **挑战题（optional）**：请问上面的例子中， FDR是如何计算出的。请写出公式，并解释原理。
