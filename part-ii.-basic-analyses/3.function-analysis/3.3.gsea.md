...
3. 选择合适的参数，参数意义详见 [command line 模式](3.3.gsea.md#gsea-command) 第 3 行的解释。
...
1. 分析 GSE2251 中与 _TP53_ 基因的表达量显著相关的 gene set，输入文件在 [这里](https://cloud.tsinghua.edu.cn/d/2cc272d2e6624537b716/) 下载。
