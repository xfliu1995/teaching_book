...
1. 将 [`THA2.fa`](../files/mapping/THA2.fa) map 到 `BowtieIndex/YeastGenome` 上，得到 `THA2.sam`。
2. 将 [`e_coli_500.fq`](../files/mapping/e_coli_500.fq) map 到 `bowtie-src/indexes/e_coli` 上，得到 `e_coli_500.sam`。
