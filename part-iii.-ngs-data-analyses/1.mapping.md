...
1. 将 [`THA2.fa`](https://cloud.tsinghua.edu.cn/f/734a872982054b799056/) map 到 `BowtieIndex/YeastGenome` 上，得到 `THA2.sam`。
2. 将 [`e_coli_500.fq`](https://cloud.tsinghua.edu.cn/f/98a662994cca47559f55/) map 到 `bowtie-src/indexes/e_coli` 上，得到 `e_coli_500.sam`。
