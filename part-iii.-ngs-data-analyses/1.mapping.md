...
|File|Content |
|:-|:-|
|[`THA2.fa`](https://github.com/lulab/teaching_book/tree/master/files/PART_III/1.mapping) |作业中需要比对到Yeast 的fasta |
|[`e_coli_500.fq`](https://github.com/lulab/teaching_book/tree/master/files/PART_III/1.mapping)  | 作业中需要比对到 E. coli 的fasta |
